...
public class EmployeeDaoImp implements IEmployeeDao {
	...
	public int addEmployee(Employee emp) {
		...
		try {
			PreparedStatement pstmt =		conn.prepareStatement("insert into  Emp_Info  values(?,?,?)");
	...
	public List<Employee> displayAllEmployees() {
		...
		try {
			PreparedStatement pstmt =		conn.prepareStatement("Select  eid,ename ,salary from Emp_Info");
